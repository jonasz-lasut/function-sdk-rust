...
pub struct RunFunctionRequest {
    ...
    pub required_schemas: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        Schema,
    >,
}
...
pub struct RunFunctionResponse {
    ...
    pub output: ::core::option::Option<::pbjson_types::Struct>,
}
...
pub struct Schema {
    ...
    #[prost(message, optional, tag = "1")]
    pub openapi_v3: ::core::option::Option<::pbjson_types::Struct>,
}
...
impl Capability {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "CAPABILITY_CAPABILITIES" => Some(Self::Capabilities),
            "CAPABILITY_REQUIRED_RESOURCES" => Some(Self::RequiredResources),
            "CAPABILITY_CREDENTIALS" => Some(Self::Credentials),
            "CAPABILITY_CONDITIONS" => Some(Self::Conditions),
            "CAPABILITY_REQUIRED_SCHEMAS" => Some(Self::RequiredSchemas),
            _ => None,
        }
    }
}
